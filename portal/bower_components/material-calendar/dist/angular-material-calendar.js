 var app = angular.module("myApp", ["ngMaterial", "ngSanitize"]);

app.constant("materialCalendar.config", {
    version: "0.2.13",
    debug: document.domain.indexOf("localhost") > -1
});

app.config(["materialCalendar.config", "$logProvider", "$compileProvider", function (config, $logProvider, $compileProvider) {
    if (config.debug) {
...
app.service("materialCalendar.Calendar", [function () {
...
app.service("MaterialCalendarData", [function () {
